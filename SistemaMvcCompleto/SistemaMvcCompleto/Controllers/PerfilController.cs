    ...
    public class PerfilController : Controller
    {
        ...
        public async Task<IActionResult> Perfil()
        {
            ...
            var model = new PerfilDto
            {
                ...
                // Proteção contra nulos na propriedade FotoUrl
        ...
        public async Task<IActionResult> AtualizarPerfil(PerfilDto model, IFormFile? FotoPerfil)
        {
            ...
            // 2. Processamento da Foto de Perfil
            ...
            // Persistence dos dados básicos no banco
            ...
            // 3. Processamento de Troca de Senha (se o usuário preencheu os campos)
